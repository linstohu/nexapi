...
func (o *UsdMFuturesAccountClient) NewOrder(ctx context.Context, param types.NewOrderParam) (*types.Order, error) {
	req := umutils.HTTPRequest{
		SecurityType: umutils.TRADE,
		BaseURL:      o.GetBaseURL(),
		Path:         "/fapi/v1/order",
...
func (o *UsdMFuturesAccountClient) QueryOrder(ctx context.Context, param types.GetOrderParam) (*types.Order, error) {
	req := umutils.HTTPRequest{
...
func (o *UsdMFuturesAccountClient) QueryOpenOrder(ctx context.Context, param types.GetOrderParam) (*types.Order, error) {
	req := umutils.HTTPRequest{
		SecurityType: umutils.USER_DATA,
		BaseURL:      o.GetBaseURL(),
...
func (o *UsdMFuturesAccountClient) QueryAllOpenOrders(ctx context.Context, param types.GetAllOpenOrdersParam) ([]*types.Order, error) {
	req := umutils.HTTPRequest{
		SecurityType: umutils.USER_DATA,
		BaseURL:      o.GetBaseURL(),
...
func (o *UsdMFuturesAccountClient) CancelOrder(ctx context.Context, param types.GetOrderParam) (*types.Order, error) {
	req := umutils.HTTPRequest{
		SecurityType: umutils.TRADE,
		BaseURL:      o.GetBaseURL(),
		Path:         "/fapi/v1/order",
...
func (o *UsdMFuturesAccountClient) CancelAllOpenOrders(ctx context.Context, param types.CancelAllOpenOrdersParam) error {
	req := umutils.HTTPRequest{
		SecurityType: umutils.TRADE,
		BaseURL:      o.GetBaseURL(),
...
func (o *UsdMFuturesAccountClient) GetAllOrders(ctx context.Context, param types.GetAllOrdersParam) ([]*types.Order, error) {
	req := umutils.HTTPRequest{
		SecurityType: umutils.USER_DATA,
		BaseURL:      o.GetBaseURL(),
...
func (o *UsdMFuturesAccountClient) GetBalance(ctx context.Context) ([]*types.Balance, error) {
	req := umutils.HTTPRequest{
		SecurityType: umutils.USER_DATA,
		BaseURL:      o.GetBaseURL(),
...
func (o *UsdMFuturesAccountClient) GetAccountInformation(ctx context.Context) (*types.Account, error) {
	req := umutils.HTTPRequest{
		SecurityType: umutils.USER_DATA,
		BaseURL:      o.GetBaseURL(),
...
func (o *UsdMFuturesAccountClient) ChangeInitialLeverage(ctx context.Context, param types.ChangeLeverageParam) (*types.ChangeLeverageResp, error) {
	req := umutils.HTTPRequest{
		SecurityType: umutils.TRADE,
		BaseURL:      o.GetBaseURL(),
...
func (o *UsdMFuturesAccountClient) ChangeMarginType(ctx context.Context, param types.ChangeMarginTypeParam) error {
	req := umutils.HTTPRequest{
		SecurityType: umutils.TRADE,
		BaseURL:      o.GetBaseURL(),
...
func (o *UsdMFuturesAccountClient) ModifyIsolatedPositionMargin(ctx context.Context, param types.ModifyIsolatedPositionMarginParam) (*types.ModifyIsolatedPositionMarginResp, error) {
	req := umutils.HTTPRequest{
		SecurityType: umutils.TRADE,
		BaseURL:      o.GetBaseURL(),
...
func (o *UsdMFuturesAccountClient) GetPositionInformation(ctx context.Context, param types.GetPositionParam) ([]*types.Position, error) {
	req := umutils.HTTPRequest{
		SecurityType: umutils.USER_DATA,
		BaseURL:      o.GetBaseURL(),
...
func (o *UsdMFuturesAccountClient) GetAccountTradeList(ctx context.Context, param types.GetTradeListParam) ([]*types.Trade, error) {
	req := umutils.HTTPRequest{
		SecurityType: umutils.USER_DATA,
		BaseURL:      o.GetBaseURL(),
