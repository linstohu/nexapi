...
func NewMarketStreamClient(ctx context.Context, cfg *MarketStreamCfg) (*MarketStreamClient, error) {
	if err := validator.New().Struct(cfg); err != nil {
		return nil, err
	}

	cli := &MarketStreamClient{
		baseURL: cfg.BaseURL,
		debug:   cfg.Debug,
		logger:  cfg.Logger,
...
func (m *MarketStreamClient) start() error {
	m.conn = nil
...
func (m *MarketStreamClient) connect() (*websocket.Conn, *http.Response, error) {
...
func (m *MarketStreamClient) reconnect() {
	<-m.disconnect
...
func (m *MarketStreamClient) close() error {
	close(m.disconnect)
...
func (m *MarketStreamClient) setIsConnected(state bool) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *MarketStreamClient) IsConnected() bool {
	m.mu.RLock()
	defer m.mu.RUnlock()
...
func (m *MarketStreamClient) readMessages() {
	for {
		select {
		case <-m.ctx.Done():
...
func (m *MarketStreamClient) resubscribe() error {
...
func (m *MarketStreamClient) send(req *types.Request) error {
	m.sending.Lock()
